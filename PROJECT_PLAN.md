...
- Support both light and dark appearance via `prefers-color-scheme` with an explicit `data-theme` override, exactly as Silent Lattice does. Never ship a light-only or dark-only UI.
